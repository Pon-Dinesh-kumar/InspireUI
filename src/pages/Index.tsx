  ...
  return (
    <div className="min-h-screen flex flex-col bg-darkbg overflow-hidden">
      ...
      <nav className="w-full py-4 px-8 flex justify-between items-center">
        <Link to="/" className="text-2xl font-bold text-purple">InspireUI</Link>
        <div className="flex items-center gap-4">
          <Button variant="ghost" className="text-white/80 hover:text-white">Login</Button>
          <Button className="bg-purple border border-purple-light/20 hover:bg-purple-dark text-white">Register</Button>
        </div>
      </nav>
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-16 md:px-16">
          <div className="max-w-lg">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              <span className="text-purple">Decode</span> and<br />
              <span className="text-purple">Recreate</span><br />
            ...
            <div className="flex space-x-4">
              <Button 
                className="bg-purple hover:bg-purple-dark text-white border border-purple-light/20 px-6 py-6"
                asChild
              >
              ...
              <Button 
                variant="outline" 
                className="border-white/20 hover:bg-white/5 px-6 py-6"
              >
                Learn More
              </Button>
            </div>
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-8 relative">
          <div className="absolute top-0 right-0 w-full h-full bg-gradient-radial from-purple/10 to-transparent opacity-70"></div>
          <div className="relative w-full max-w-lg aspect-square glass rounded-2xl overflow-hidden">
            ...
            <div className="p-8 flex flex-col h-full">
              ...
              <div className="flex gap-8 mb-6">
                ...
                <div className="w-1/2">
                  <div className="h-2 w-1/3 bg-teal rounded mb-3"></div>
                  <div className="h-2 w-full bg-gray-700 rounded mb-2"></div>
                  <div className="h-2 w-5/6 bg-gray-700 rounded mb-2"></div>
                  <div className="h-2 w-4/6 bg-gray-700 rounded"></div>
                </div>
              ...
              <div className="mt-auto bg-darkbg-lighter/50 rounded-lg p-4">
                <div className="h-3 w-1/3 bg-purple rounded mb-3"></div>
                <div className="h-2 w-full bg-gray-700 rounded mb-2"></div>
      ...
      <div className="bg-darkbg py-16 px-8 initial-hidden opacity-0">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-darkbg-lighter glass-dark p-8 rounded-xl text-center hover:bg-darkbg-panel transition-all duration-300">
          ...
          <div className="mt-12 text-center">
            <Button 
              className="bg-purple hover:bg-purple-dark text-white border border-purple-light/20" 
              size="lg" 
              asChild
            >
